          ...
          <div className="bg-white rounded-[3rem] shadow-2xl border border-black/5 p-8 md:p-16 animate-fadeInUp">
            <div className="space-y-10">
              <div className="flex items-center gap-6 border-b border-gray-100 pb-8">
                ...
                <div>
                  <h2 className="text-4xl font-bold text-(--heading-dark)">Privacy Commitment</h2>
                  <p className="text-(--body-grey) font-semibold mt-1">Effective Date: January 1, 2025</p>
                </div>
              </div>

              <div className="space-y-8 text-xl leading-relaxed text-(--body-grey)">
                <p>
                  At <span className="font-bold text-(--heading-dark)">Cyvora Tech</span>, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains our practices regarding the collection and use of your data.
                </p>

                <div className="space-y-4">
                  <h3 className="text-3xl font-bold text-(--heading-dark)">Information We Collect</h3>
                  <p>In order to provide our premium telecom solutions, we collect specific information including:</p>
                  <ul className="space-y-4 list-none p-0">
                    <li className="flex items-start gap-4 p-4 bg-(--body-bg) rounded-2xl">
                      ...
                      <span><span className="font-bold text-(--heading-dark)">Account Data:</span> Name, work email, phone number, and corporate credentials.</span>
                    </li>
                    <li className="flex items-start gap-4 p-4 bg-(--body-bg) rounded-2xl">
                      <div className="mt-2 w-2 h-2 bg-(--accent-copper) rounded-full shrink-0"></div>
                      <span><span className="font-bold text-(--heading-dark)">Technical Logs:</span> IP addresses, browser specifications, and navigation patterns on our infrastructure.</span>
                    </li>
                    <li className="flex items-start gap-4 p-4 bg-(--body-bg) rounded-2xl">
                      <div className="mt-2 w-2 h-2 bg-(--accent-copper) rounded-full shrink-0"></div>
                      <span><span className="font-bold text-(--heading-dark)">Communication Logs:</span> Timestamps and routing metadata essential for service delivery.</span>
                    </li>
                  </ul>
                </div>

                <div className="space-y-4">
                  <h3 className="text-3xl font-bold text-(--heading-dark)">Usage & Protection</h3>
                  <p>
                    Your data is strictly utilized to maintain, enhance, and secure our global communication services. We implement bank-grade encryption and rigorous access controls to ensure your information remains confidential.
                  </p>
                  <p>
                    We maintain a strict policy against selling or renting your personal data to third-party marketers.
                  </p>
                </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl">
                        ...
                        <div>
                          <p className="text-xs opacity-70 uppercase font-bold">Phone</p>
                      ...
                      <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl md:col-span-2">
                        ...
                        <div>
                          <p className="text-xs opacity-70 uppercase font-bold">Headquarters</p>
